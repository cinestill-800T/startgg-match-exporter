...
[![Release](https://img.shields.io/badge/release-v2.5.11-green.svg)](https://github.com/cinestill-800T/startgg-match-exporter/releases/tag/v2.5.11)
...
- `敗退済み`: the entrant's latest completed result is a loss and no unfinished set remains; the bracket badge is omitted because the entrant is no longer active
