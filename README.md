...
StartGG Match Exporter is a small macOS SwiftUI app that exports a start.gg event into JSON for downstream analysis with external AI tools.
...
Create a token in start.gg Developer Settings and paste it into the app. The token is stored in the macOS Keychain.
...
3. Paste your start.gg API token.
4. Click `Fetch Data`.
5. Click `Save JSON`.
